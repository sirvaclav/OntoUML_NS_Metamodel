...
@ExpanderTest
class PhaseMixinExpanderTest {

  @TestModel(select = "ontoUml::BigCityPhaseMixin")
  Spec baseModel() {
    return component("ontoUml",
        dataElement("BigCity"),
        objectType(phaseMixin("BigCityPhaseMixin",
  ...
  void testArtifactPath(TestExpansion<ObjectTypeComposite> expansion) {
    expansion
        .assertThatExpander()
        .hasArtifactPath("C:/MODULE_ROOT/shared/gen/common/src/BigCityPhaseMixin.java");
  }
