...
@ExpanderTest
class RelatorExpanderTest {
  @TestModel(select = "ontoUml::IndustryRelator")
  Spec baseModel() {
    return component("ontoUml",
        dataElement("Industry"),
        objectType(relator("IndustryRelator",
  ...
  void testArtifactPath(TestExpansion<ObjectTypeComposite> expansion) {
    expansion
        .assertThatExpander()
        .hasArtifactPath("C:/MODULE_ROOT/shared/gen/common/src/IndustryRelator.java");
  }
