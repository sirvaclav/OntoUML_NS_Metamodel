...
@ExpanderTest
class MixinExpanderTest {

  @TestModel(select = "ontoUml::BigCityMixin")
  Spec baseModel() {
    return component("ontoUml",
      dataElement("BigCity"),
      objectType(mixin("BigCityMixin",
  ...
  void testArtifactPath(TestExpansion<ObjectTypeComposite> expansion) {
    expansion
        .assertThatExpander()
        .hasArtifactPath("C:/MODULE_ROOT/shared/gen/common/src/BigCityMixin.java");
  }
