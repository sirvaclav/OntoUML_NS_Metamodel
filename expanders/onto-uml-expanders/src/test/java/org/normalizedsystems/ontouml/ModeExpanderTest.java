...
import static ontoUml.spec.OntoUmlSpecs.phase;
import static org.hamcrest.MatcherAssert.assertThat;
import static org.hamcrest.Matchers.*;

@ExpanderTest
class ModeExpanderTest {

  @TestModel(select = "ontoUml::IndustryMode")
  Spec baseModel() {
    return component("ontoUml",
        dataElement("Industry"),
        kind("PersonKind"),
        objectType(mode("IndustryMode",
            dataRef("dataElement", "ontoUml::Industry"),
            dataRef("modeExistentialDependency", "ontoUml::PersonKind")
        ))
    );
  }
  ...
  void testArtifactPath(TestExpansion<ObjectTypeComposite> expansion) {
    expansion
        .assertThatExpander()
        .hasArtifactPath("C:/MODULE_ROOT/shared/gen/common/src/IndustryMode.java");
  }
